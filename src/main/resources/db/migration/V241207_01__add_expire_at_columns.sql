...
ALTER TABLE notification.scheduled_job
    ADD COLUMN expire_at TIMESTAMP WITHOUT TIME ZONE NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE notification.push_notification
    ADD COLUMN expire_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE notification.notification
    ADD COLUMN expire_at TIMESTAMP WITHOUT TIME ZONE;
